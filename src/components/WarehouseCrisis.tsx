      ...
      <div className="space-y-24 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <FadeInSection direction="right" delay={200}>
            <Card className="p-8 bg-destructive/10 border-destructive/50 text-center">
        ...
        {/* Revenue Loss */}
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <FadeInSection direction="left" className="md:order-first">
            <Card className="p-8 bg-accent/10 border-accent/50 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <FadeInSection direction="right" delay={200}>
            <Card className="p-8 bg-primary/10 border-primary/50 text-center">
